...
const Populer = (props) => {
    return (
        <div className='container mx-8 px-11 mt-5 '>
            ...
            <h1 className=' py-2 block font-semibold text-red-600 text-4xl border-b-2 border-red-600 '>Populer</h1>
                            ...
                            <div key={index} className='hover:scale-105 transition-all ease-in'>
                                ...
                                <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5 border border-blue-700">
                                    <CardHeader className="absolute z-10 top-1 flex-col items-start">
                                        <p className="text-tiny text-white uppercase font-bold">Populer</p>
                                    </CardHeader>
                                    <Image
                                        removeWrapper
